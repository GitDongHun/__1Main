...
*/
      ...
      var isServerRendering = function () {
          if (_isServer === undefined) { /* istanbul ignore if */
...
*/
      ...
      function assertObjectType(name, value, vm) {
          if (! isPlainObject(value)) {
              warn("Invalid value for option \"" + name + "\": expected an Object, " + "but got " + (
                  toRawType(value)
              ) + ".", vm);
          }
      }
...
*/
      function assertProp(prop, name, value, vm, absent) {
          ...
          if (! valid) {
              warn("Invalid prop: type check failed for prop \"" + name + "\"." + " Expected " + (
...
*/
      ...
      function updateListeners(on, oldOn, add, remove$$1, vm) {
          ...
          for (name in on) {
              ...
              /* istanbul ignore if */
              if (isUndef(cur)) {
                  "development" !== 'production' && warn("Invalid handler for event \"" + (
                      event.name
                  ) + "\": got " + String(cur), vm);
              } else if (isUndef(old)) {
                  if (isUndef(cur.fns)) {
      ...
      function resolveAsyncComponent(factory, baseCtor, context) {
          ...
          if (isDef(factory.contexts)) { // already pending
              ...
              var reject = once(function (reason) {
                  "development" !== 'production' && warn("Failed to resolve async component: " + (
                      String(factory)
                  ) + (
                      reason
                          ? ("\nReason: " + reason)
...
*/
      ...
      function mountComponent(vm, el, hydrating) {
          ...
          if (! vm.$options.render) {
              ...
              { /* istanbul ignore if */
                  if ((vm.$options.template && vm
                      .$options
                      .template
                      .charAt(0) !== '#') || vm.$options.el || el) {
...
*/
      ...
      function initInjections(vm) {
          ...
          if (result) {
              toggleObserving(false);
              Object.keys(result).forEach(function (key) { /* istanbul ignore else */
                  {
      ...
      function resolveInject(inject, vm) {
          if (inject) { // inject is :any because flow is not smart enough to figure out cached
              ...
              var keys = hasSymbol
                  ? Reflect.ownKeys(inject).filter(function (key) { /* istanbul ignore next */
...
*/
      function markOnce(tree, index, key) {
          markStatic(tree, ("__once__" + index + (
              key
                  ? ("_" + key)
                  : ""
          )), true);
      ...
      function createComponent(Ctor, data, context, children, tag) {
          ...
          var vnode = new VNode(("vue-component-" + (
              Ctor.cid
          ) + (
              name
                  ? ("-" + name)
      ...
      function _createElement(context, tag, data, children, normalizationType) {
          if (isDef(data) && isDef((data).__ob__)) {
              "development" !== 'production' && warn("Avoid using observed data object as vnode data: " + (
                  JSON.stringify(data)
 ...
 */
      ...
      function isUnknownElement(tag) { /* istanbul ignore if */
          if (! inBrowser) {
              return true
          }
...
*/
      ...
      function createElement$1(tagName, vnode) {
          ...
          if (vnode.data && vnode.data.attrs && vnode
                  .data
                  .attrs
                  .multiple !== undefined) {
  ...
  function parseFilters(exp) {
      ...
      for (i = 0; i < exp.length; i++) {
          ...
          exp.charCodeAt(i + 1) !== 0x7C && exp.charCodeAt(i - 1) !== 0x7C && ! curly && ! square && ! paren) {
              ...
              switch (c) {
                  case 0x22: inDouble = true;
                      break // "
                  case 0x27: inSingle = true;
                      break // '
                  case 0x60: inTemplateString = true;
                      break // `
                  case 0x28: paren++;
                      break // (
                  case 0x29: paren--;
...
*/
  ...
  function model(el, dir, _warn) {
      ...
      if (el.component) {
          ...
          warn$1("<" + (
              el.tag
          ) + " v-model=\"" + value + "\">: " + "v-model is not supported on this element type. " + 'If you are working with contenteditable, it\'s recommended to ' + 'wrap a library dedicated for that purpose inside a custom component.');
      }
  ...
  function genCheckboxModel(el, value, modifiers) {
      ...
      addHandler(el, 'change', "var $$a=" + value + "," + '$$el=$event.target,' + "$$c=$$el.checked?(" + trueValueBinding + "):(" + falseValueBinding + ");" + 'if(Array.isArray($$a)){' + "var $$v=" + (
          number
              ? '_n(' + valueBinding + ')'
              : valueBinding
...
*/
  ...
  var setProp = function (el, name, val) { /* istanbul ignore if */
...
*/
  ...
  if (hasTransition) { /* istanbul ignore if */
  ...
  function getTimeout(delays, durations) { /* istanbul ignore next */
...
var transition = inBrowser
  ? {
      create: _enter,
      activate: _enter,
      remove: function remove$$1(vnode, rm) { /* istanbul ignore else */
          if (vnode.data.show !== true) {
              leave(vnode, rm);
          } else {
              rm();
...
function actuallySetSelected(el, binding, vm) {
  ...
  if (isMultiple && !Array.isArray(value)) {
      "development" !== 'production' && warn("<select multiple v-model=\"" + (
          binding.expression
...
var Transition = {
  ...
  render: function render(h) {
      ...
      if (child.data.directives && child
              .data
              .directives
              .some(function (d) {
                  return d.name === 'show';
      ...
      // #6687 component root is a comment node
          !(oldChild.componentInstance && oldChild
          .componentInstance
          ._vnode
          .isComment)) {
...
var TransitionGroup = {
  ...
  methods: {
      hasMove: function hasMove(el, moveClass) { /* istanbul ignore if */
          if (!hasTransition) {
              return false
          }
          /* istanbul ignore if */
...
function callPendingCbs(c) { /* istanbul ignore if */
  if (c.elm._moveCb) {
      c.elm._moveCb();
  }
  /* istanbul ignore if */
...
function transformNode$1(el, options) {
  ...
  if (staticStyle) { /* istanbul ignore if */
      {
      ...
      if (! lastTag || ! isPlainTextElement(lastTag)) {
          ...
          var rest$1 = html.replace(reStackedTag, function (all, text, endTag) {
              ...
              if (! isPlainTextElement(stackedTag) && stackedTag !== 'noscript') {
                  text = text.replace(/<!\--([\s\S]*?)-->/g, '$1') // #7298.replace(/<!\[CDATA\[([\s\S]*?)]]>/g, '$1');
              }
...
warn$2 = options.warn || baseWarn;
      ...
      function processSlot(el) {
          if (el.tag === 'slot') {
              ...
              } else if ((slotScope = getAndRemoveAttr(el, 'slot-scope'))) { /* istanbul ignore if */
                  if ("development" !== 'production' && el.attrsMap['v-for']) {
                      warn$2("Ambiguous combined usage of slot-scope and v-for on <" + (
                          el.tag
                      ) + "> " + "(v-for takes higher priority). Use a wrapper <template> for the " + "scoped slot to make it clearer.", true);
                  }
  ...
  function checkForAliasModel(el, value) {
      ...
      while (_el) {
          if (_el.for && _el.alias === value) {
              warn$2("<" + (
                  el.tag
              ) + " v-model=\"" + value + "\">: " + "You are binding v-model directly to a v-for iteration alias. " + "This will not be able to modify the v-for source array because " + "writing to the alias is like modifying a function local variable. " + "Consider using an array of objects and use v-model on an object property instead.");
          }
          _el = _el.parent;
      }
  }
...
*/
  ...
  function genFor(el, state, altGen, altHelper) {
      ...
      if ("development" !== 'production' && state.maybeComponent(el) && el.tag !== 'slot' && el.tag !== 'template' && ! el.key) {
          state.warn("<" + (
              el.tag
          ) + " v-for=\"" + alias + " in " + exp + "\">: component lists rendered with " + "v-for should have explicit keys. " + "See https://vuejs.org/guide/list.html#key for more info.", true /* tip */
          );
      }
      el.forProcessed = true; // avoid recursion
      return(altHelper || '_l') + "((" + exp + ")," + "function(" + alias + iterator1 + iterator2 + "){" + "return " + (
  ...
  function genForScopedSlot(key, el, state) {
      ...
      var iterator2 = el.iterator2
          ...
          : '';
      el.forProcessed = true; // avoid recursion
      return "_l((" + exp + ")," + "function(" + alias + iterator1 + iterator2 + "){" + "return " + (
